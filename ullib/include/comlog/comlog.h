...
do { \
	if (comlog_get_log_level() >= COMLOG_TRACE) { \
...
do { \
	if (comlog_get_log_level() >= COMLOG_DEBUG) { \
 ...
 * @note only changes global log level @linjieqiong 2013-04-17
 *
 * @return  int 
 * @retval   
 * @see 
