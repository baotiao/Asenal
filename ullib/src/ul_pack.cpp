 ...
 * $Id: ul_pack.cpp,v 1.4 2009/09/18 11:02:57 sun_xiao Exp $ 
 * 
 **************************************************************************/
...
/**
 * @brief 根据输入的name删除key-value对
 *
 * @param [in/out] ppack   : ul_package_t*
 * @param [in/out] pname   : const char* 希望删除的key值
 * @return  int 
 * -1 删除失败 输入错误或key值不存在
 * 0 删除成功
 * @retval   
