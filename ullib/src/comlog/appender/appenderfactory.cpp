 ...
 * $Id: appenderfactory.cpp,v 1.3.4.1 2010/03/25 08:18:08 zhang_rui Exp $ 
 * 
 **************************************************************************/
...
/**
 * @file appender/AppenderFactory.cpp
 * @author yingxiang(com@baidu.com)
 * @date 2008/09/05 12:25:10
...
Appender* AppenderFactory :: getAppender(com_device_t &dev){
	...
	*/
	...
	if (app != NULL) {
		...
		if (dev.layout != comlog_get_def_layout()) {
			comlog_get_nameMg()->set(dev.name, dev.layout);
		}
