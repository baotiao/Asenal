 ...
 * /home/zhang_rui/dev/libsrc/ullib/src/comlog/test/test/test_comlog.cpp 2010/04/01 20:08:28 zhang_rui Exp 
 * 
 **************************************************************************/
...
/**
 * @file /home/zhang_rui/dev/libsrc/ullib/src/comlog/test/test/test_comlog.cpp
 * @author zhang_rui(com@baidu.com)
 * @date 2010/04/01 20:08:28
 * @brief 
 *  
 **/
...
class test_com_ul_log_suite : public ::testing::Test{
    protected:
...
class test_comlog_suite : public ::testing::Test{
    protected:
        test_comlog_suite(){};
