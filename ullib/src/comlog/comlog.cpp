...
/**
 * @brief  获得不高于指定等级（COMLOG_LEVEL）的系统日志
 ...
 *               (1 << 4) | (1 << 2) | (1 << 1) = 0x16
 * @note   该函数需要暴露给comsig.cpp，所以没有声明为static。
